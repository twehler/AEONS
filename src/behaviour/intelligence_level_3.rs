// Level 3 intelligence — placeholder.
//
...
// here, the simulation routes initial-spawn L3 rolls back to L1
// (see `IntelligenceLevel::for_initial_spawn`).

use bevy::prelude::*;


/// Marker for organisms whose intelligence level is 3.
///
...
/// with `Level3` organisms still load, and so future work can hang
/// real systems off this marker without renaming the enum variant.
#[derive(Component, Clone, Copy, Debug)]
#[allow(dead_code)]
pub struct BrainLevel3;
