...
//
// Architectural port of `intelligence_level_3_sliding.rs` (the Krishi brain),
...
pub fn assign_brains_herbivore_1(
    ...
    for (e, organism, inheritance, restore) in new.iter() {
        ...
        // Sliding pool — limb-based organisms (sliding_movement = false)
        // enrol in the parallel limb-based herbivore_1 pool instead.
