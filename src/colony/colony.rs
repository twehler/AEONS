...
fn spawn_colony(
    ...
    *spawned = true;
    ...
    // Two shared materials, one per trophic strategy: photoautotrophs green,
    // heterotrophs red. Sharing a single handle per kind keeps GPU bind-group
    // churn minimal across the ≤1100-organism population.
